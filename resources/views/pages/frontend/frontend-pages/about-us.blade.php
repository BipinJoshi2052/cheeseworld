                ...
                <div class="about-us-list">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 order-xl-1 order-lg-1 order-md-1 order-2 mb-2">
                            <div class="about-us-image-discription d-flex h-100 justify-content-center align-items-end flex-column py-3">
                                <h2>Our Story</h2>
                                <p class="text-right">Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora commodi corporis omnis aliquid minima sapiente exercitationem nemo ad amet, quae voluptatem fugit eaque quo. Eaque aperiam at blanditiis! Doloribus, sunt.</p>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 order-xl-2 order-lg-2 order-md-2 order-1 mb-2">
                            <div class="about-us-image">
                                <img src="frontend/assets/images/product-images/10.jpg " class="img-fluid ">
                            </div>
                        </div>
                        <section id="video-wrapper" class="about-us-video-wrapper my-4 order-xl-3 order-lg-3 col-12 mb-4">
                            <div class="video-info position-relative">
                                <img src="frontend/assets/images/product-images/5.jpg" class="img-fluid" alt="video-image">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 order-xl-5 order-lg-5 order-md-5 order-5 mb-2">
                            <div class="about-us-image-discription d-flex h-100 justify-content-center align-items-start flex-column py-3">
                                <h2>Our Goals</h2>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora commodi corporis omnis aliquid minima sapiente exercitationem nemo ad amet, quae voluptatem fugit eaque quo. Eaque aperiam at blanditiis! Doloribus, sunt.</p>
                            </div>
                        </div>
                    </div>
                </div>
