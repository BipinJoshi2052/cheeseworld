...
?>
  <div id="checkout_page" class="container">
      @if( Cart::count() >0 )
      <form class="form-horizontal" method="post" action="" id="checkoutForm" enctype="multipart/form-data">
                ...
                @if($payment_method_data['payment_option']['enable_payment_method'] == 'yes' && ($payment_method_data['bacs']['enable_option'] == 'yes' || $payment_method_data['cod']['enable_option'] == 'yes' || $payment_method_data['paypal']['enable_option'] == 'yes' || $payment_method_data['stripe']['enable_option'] == 'yes'))
                  <div class="payment-options">
                   ...
                   @if($payment_method_data['esewa']['enable_option'] == 'yes')
                    <span>
                     <label>
                       @if(old('payment_option') == 'esewa')
                        <input type="radio" checked name="payment_option" class="shopist-iCheck" value="esewa"> {{ $payment_method_data['esewa']['method_title'] }}
                       @else
                        <input type="radio" name="payment_option" class="shopist-iCheck" value="esewa"> {{ $payment_method_data['esewa']['method_title'] }}
                       @endif
                     </label>
                    </span>
                   @endif
