...
<style>
  ...
  #store_details .profile-details .vendor-name h3 {
    display: flex;
    justify-content:center;
    align-items:center;
  }
          ...
          <div class="profile-overlay">
            <div class="profile-details-content">
                ...
                <div class="profile-details">
                  <div class="vendor-name"><h3>{!! $vendor_settings->profile_details->store_name !!} <span class="verified ml-2"><i class="fa fa-check" aria-hidden="true"></i></span></h3></div>
                  <table>
