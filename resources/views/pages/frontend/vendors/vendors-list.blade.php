            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
              <div class="vendors-list-content">
                ...
                <div class="vendors-list-profile-details">
                  <div class="vendor-name mt-3"><h3><a href="{{ route('store-details-page-content', $vendor->name) }}">{!! $details->profile_details->store_name !!}</a><span class="verified ml-2"><i class="fa fa-check" aria-hidden="true"></i></span></h3></div>
