                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="padding:36px 40px;display:block;">
                                                            ...
                                                            <div style="text-align:center;margin-top: 30px;"><h1 style="color:#ffffff;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:30px;font-weight:300;line-height:150%;margin:0;">{!! $data['new_order']['email_heading'] !!}</h1></div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
