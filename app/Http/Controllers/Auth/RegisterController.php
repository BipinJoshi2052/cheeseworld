        ...
        if (!empty($get_available_roles)) {
          ...
          if ($User->save()) {
            ...
            if ($Roleuser->save()) {
              ...
              $vendor_data['profile_details'] = array('store_name' => Request::Input('vendor_reg_store_name'), 'address_line_1' => Request::Input('vendor_reg_address_line_1'), 'address_line_2' => Request::Input('vendor_reg_address_line_2'), 'city' => Request::Input('vendor_reg_city'), 'state' => Request::Input('vendor_reg_state'), 'country' => Request::Input('vendor_reg_country'), 'zip_postal_code' => Request::Input('vendor_reg_zip_code'), 'phone' => Request::Input('vendor_reg_phone_number'));
