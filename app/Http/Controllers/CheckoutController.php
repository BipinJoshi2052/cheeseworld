...
class CheckoutController extends Controller
{
    ...
    public function doCheckoutProcess()
    {
        ...
        // dd(Request::Input('payment_option') === 'esewa');
        $data = Request::all();
                ...
                if ($validator->fails()) {
                    ...
                    if (Request::Input('payment_option') === 'bacs' || Request::Input('payment_option') === 'cod') {
                        ...
                        if (isset($email_options['new_order']['enable_disable']) && $email_options['new_order']['enable_disable'] == true) {
                            ...
                            if ($order_id['order_id'] > 0 && ($this->env === 'production' || $this->env === 'local')) {
                    ...
                    if (Request::Input('payment_option') === 'esewa') {
                        ...
                        $get_order_data = $this->classCommonFunction->get_order_details_by_order_id(array('order_id' => $order_id['order_id'], 'order_process_id' => $order_id['process_id']));

                        $order_total = $get_order_data['_order_total'];
                        $final_total = $get_order_data['_final_order_total'];
                        $final_shipping_cost = $get_order_data['_final_order_shipping_cost'];
                        $final_order_tax = $get_order_data['_final_order_tax'];
                        $finalOrderId = $order_id['order_id'];
                        ...
                        return response()->json(['orderId' => $finalOrderId, 'order_total' => $order_total, 'final_total' => $final_total, 'shipping' => $final_shipping_cost, 'order_tax' => $final_order_tax]);
