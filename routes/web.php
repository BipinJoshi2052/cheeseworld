...
|
*/
Route::get('login/{provider}', 'Auth\LoginController@redirect')->name('providerAuth');
Route::get('login/{provider}/callback','Auth\LoginController@Callback')->name('providerCallback');
...
Route::group(['prefix' => 'admin'], function () {
  ...
  Route::get('settings/social-media-form',[
    'uses' => 'SocialMediaController@getSocialForm',
    'as'   => 'admin.socialform'
  ])->middleware('verifyLoginPage', 'admin', 'sufficientPermission');

  Route::post('settings/social-media-form',[
    'uses' => 'SocialMediaController@saveClientIds',
    'as'   => 'admin.postSocialForm'
  ])->middleware('verifyLoginPage', 'admin', 'sufficientPermission');
